...
def main():
    rclpy.init()
    node = rclpy.node.Node('test_throttling_hbba_time_synchronizer')
    ...
    _ = hbba_lite.ThrottlingHbbaTimeSynchronizer(node, [sub1, sub2], 10, callback, 'int_topics/filter_state')
